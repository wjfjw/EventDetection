...
//		}
	...
	/**
	 * Calculate semantic relatedness between IConceptVectors
	 * @param c1
	 * @param c2
	 * @return returns relatedness if successful, -1 otherwise
	 */
	public double getVectorRelatedness(IConceptVector c1, IConceptVector c2)
	{
		try {
